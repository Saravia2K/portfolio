      ...
      <g mask="url(#c)">
        ...
        <g stroke="#2F8A00">
          ...
          <path
            strokeLinecap="round"
            strokeWidth={5.91}
            d="M209.814 176.884c-23.982 2.565-42.792 10.469-56.428 23.714-13.639 13.245-23.483 26.136-29.536 38.674m95.195-71.973c29.028-7.723 50.972-10.173 65.831-7.352 14.859 2.822 26.807 7.659 35.842 14.51m-109.408-1.839c20.29 9.106 38.353 19.052 54.186 29.837 15.833 10.786 27.714 20.99 35.643 30.617"
          />
        </g>
        <path
          stroke="#830305"
